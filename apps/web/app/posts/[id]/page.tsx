...
import type { RouterOutputs } from "@workspace/eden";
...
type Post = RouterOutputs["public"]["posts"]["get"]["data"][number];
...
export default function ArtPiecePage() {
  ...
  const { data: post, isPending } = useQuery({
    ...
    queryFn: () => api.public.posts.get({ query: { id: params.id as string } }),
  });

  const { data: relatedPosts } = useQuery({
    queryKey: ["related-posts", post?.data?.id],
    queryFn: () =>
      api.public.posts.get({
        query: {
          ...
          limit: 3,
          page: 1,
          search: `author:${post?.data?.author.id}`,
        },
      }),
          ...
          <div className="flex flex-col gap-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 mt-2 text-sm text-muted-foreground">
                      <span>
                        {postData.author.followersCount?.toLocaleString() || 0}{" "}
                        followers
                      </span>
                      <span>{postData.author.postsCount || 0} works</span>
            ...
            <div className="grid grid-cols-4 gap-4">
              ...
              <div className="flex flex-col items-center p-4 rounded-lg bg-muted/50">
                ...
                <span className="font-medium mt-1">
                  {(postData.viewsCount || 0).toLocaleString()}
                </span>
              ...
              <CardContent className="p-4">
                <div className="space-y-4">
                  <div className="flex items-center gap-2 text-sm text-muted-foreground">
                    ...
                    <span>
                      Posted {formatDistanceToNow(new Date(postData.createdAt))}{" "}
                      ago
                    </span>
                  </div>
          ...
          <div className="mt-12">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold">
                More from {postData.author.name}
              </h2>
              <div className="flex items-center gap-2">
                <Button
                  variant="ghost"
            ...
            >
              {relatedPosts.data.map((work: Post) => (
